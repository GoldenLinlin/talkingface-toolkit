...
import torch
from talkingface.model.text_to_speech.pc_avs.architecture import get_nonspade_norm_layer
import torch.nn.functional as F


class MultiscaleDiscriminator(PC_AVS):
    @staticmethod
...
class NLayerDiscriminator(PC_AVS):
    @staticmethod
    def modify_commandline_options(parser, is_train):
...
class AudioSubDiscriminator(PC_AVS):
...
class ImageDiscriminator(PC_AVS):
...
class FeatureDiscriminator(PC_AVS):
    def __init__(self, opt):
